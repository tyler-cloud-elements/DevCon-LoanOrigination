 ...
 */
const CONVERSATIONAL_PAGINATION = {
 ...
 */
const CONVERSATIONAL_TOKEN_PARAMS = {
 ...
 */
const AUTOPILOT_BASE = 'autopilotforeveryone_';
...
const CONVERSATION_ENDPOINTS = {
    ...
    GET: (id) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${id}`,
    UPDATE: (id) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${id}`,
    DELETE: (id) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${id}`
};
/**
 * Exchange Endpoints
 */
const EXCHANGE_ENDPOINTS = {
    LIST: (conversationId) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${conversationId}/exchange`,
    GET: (conversationId, exchangeId) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${conversationId}/exchange/${exchangeId}`,
    CREATE_FEEDBACK: (conversationId, exchangeId) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${conversationId}/exchange/${exchangeId}/feedback`
};
/**
 * Message Endpoints
 */
const MESSAGE_ENDPOINTS = {
    GET: (conversationId, exchangeId, messageId) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${conversationId}/exchange/${exchangeId}/message/${messageId}`,
    GET_CONTENT_PART: (conversationId, exchangeId, messageId, contentPartId) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${conversationId}/exchange/${exchangeId}/message/${messageId}/contentPart/${contentPartId}`
};
/**
 * Attachment Endpoints
 */
const ATTACHMENT_ENDPOINTS = {
    CREATE: (conversationId) => `${AUTOPILOT_BASE}/api/${API_VERSION}/conversation/${conversationId}/attachment`
};
/**
 * Agent Endpoints
 */
const AGENT_ENDPOINTS = {
    ...
    GET: (folderId, agentId) => `${AUTOPILOT_BASE}/api/${API_VERSION}/agent/${folderId}/${agentId}`
};
/**
 * User Endpoints
 */
 ...
 */
class ConversationEventValidationError extends Error {
}
/**
 ...
 */
class ConversationEventInvalidOperationError extends Error {
}
var EventErrorId;
(function (EventErrorId) {
    EventErrorId["AGENT_COULD_NOT_BE_STARTED"] = "AGENT_COULD_NOT_BE_STARTED";
    EventErrorId["SESSION_START_PROCESSING_FAILED"] = "SESSION_START_PROCESSING_FAILED";
    EventErrorId["CLIENT_EVENT_PROCESSING_FAILED"] = "CLIENT_EVENT_PROCESSING_FAILED";
    EventErrorId["EXCHANGE_COULD_NOT_BE_CREATED"] = "EXCHANGE_COULD_NOT_BE_CREATED";
    EventErrorId["MESSAGE_COULD_NOT_BE_CREATED"] = "MESSAGE_COULD_NOT_BE_CREATED";
    EventErrorId["COULD_NOT_CREATE_CONTENT_PART"] = "COULD_NOT_CREATE_CONTENT_PART";
    EventErrorId["COULD_SIGNAL_USER_ACTIVITY"] = "COULD_SIGNAL_USER_ACTIVITY";
    EventErrorId["AGENT_EVENT_PROCESSING_FAILED"] = "AGENT_EVENT_PROCESSING_FAILED";
    EventErrorId["COULD_NOT_ENSURE_EXCHANGE"] = "COULD_NOT_ENSURE_EXCHANGE";
    EventErrorId["COULD_NOT_CREATE_MESSAGE"] = "COULD_NOT_CREATE_MESSAGE";
    EventErrorId["CONTENT_PART_HAS_CITATION_ERRORS"] = "CONTENT_PART_HAS_CITATION_ERRORS";
    EventErrorId["EXCHANGE_START_PROCESSING_FAILED"] = "EXCHANGE_START_PROCESSING_FAILED";
    EventErrorId["EXCHANGE_END_PROCESSING_FAILED"] = "EXCHANGE_END_PROCESSING_FAILED";
    EventErrorId["MESSAGE_START_PROCESSING_FAILED"] = "MESSAGE_START_PROCESSING_FAILED";
    EventErrorId["MESSAGE_END_PROCESSING_FAILED"] = "MESSAGE_END_PROCESSING_FAILED";
    EventErrorId["CONTENT_PART_START_PROCESSING_FAILED"] = "CONTENT_PART_START_PROCESSING_FAILED";
    EventErrorId["COULD_NOT_CREATE_TOOL_CALL"] = "COULD_NOT_CREATE_TOOL_CALL";
    EventErrorId["TOOL_CALL_START_PROCESSING_FAILED"] = "TOOL_CALL_START_PROCESSING_FAILED";
    EventErrorId["TOOL_CALL_END_PROCESSING_FAILED"] = "TOOL_CALL_END_PROCESSING_FAILED";
    EventErrorId["COULD_NOT_CREATE_INTERRUPT"] = "COULD_NOT_CREATE_INTERRUPT";
    EventErrorId["COULD_NOT_END_INTERRUPT"] = "COULD_NOT_END_INTERRUPT";
    EventErrorId["TEXT_CONTENT_PART_PROCESSING_FAILED"] = "TEXT_CONTENT_PART_PROCESSING_FAILED";
    EventErrorId["EXTERNAL_CONTENT_PART_PROCESSING_FAILED"] = "EXTERNAL_CONTENT_PART_PROCESSING_FAILED";
 ...
 */
class ConversationEventHelperBase {
    constructor(manager) {
        /**
        ...
        this._errorStartHandlers = new Array();
        this._errorEndHandlers = new Array();
        this._metaEventHandlers = new Array();
        this._deletedHandlers = new Array();
    ...
    onErrorStart(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._errorStartHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onErrorEnd(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._errorEndHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onMetaEvent(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._metaEventHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onDeleted(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._deletedHandlers.splice(index, 1);
        };
    }
    /**
     ...
     */
    dispatchErrorStart(errorId, startError) {
        ...
        const args = { source: this, errorId, ...startError };
        handled = this.getSession().dispatchAnyErrorStart(args) || handled;
        handled = this.manager.dispatchAnyErrorStart(args) || handled;
        if (!handled) {
            this.manager.dispatchUnhandledErrorStart(args);
        }
    }
    /**
     * Helper method for dispatching error end events. Used by subclass dispatch implementations.
     */
    dispatchErrorEnd(errorId, endError) {
        this.errors.delete(errorId);
        this._errorEndHandlers.forEach(cb => cb({ errorId, ...endError }));
        let handled = this._errorEndHandlers.length > 0;
        const args = { source: this, errorId, ...endError };
        handled = this.getSession().dispatchAnyErrorEnd(args) || handled;
        handled = this.manager.dispatchAnyErrorEnd(args) || handled;
        if (!handled) {
            this.manager.dispatchUnhandledErrorEnd(args);
        }
    }
    /**
     ...
     */
    addStartEventTimestamp(startEventMaybe) {
 ...
 */
const isInlineValue = (value) => value !== undefined && value !== null && 'inline' in value;
/**
 ...
 */
function assertInlineValue(value) {
 ...
 */
const isExternalValue = (value) => value !== undefined && value !== null && 'uri' in value;
/**
 ...
 */
function assertExternalValue(value) {
    if (!isExternalValue(value)) {
        throw new TypeError('Value is not an ExternalValue');
    }
}
function isCitationSourceUrl(citationSource) {
    return typeof citationSource.url === 'string';
}
function assertCitationSourceUrl(citationSource) {
    if (!isCitationSourceUrl(citationSource)) {
        throw new TypeError('Object is not a CitationSourceUrl');
    }
}
function isCitationSourceMedia(citationSource) {
    return typeof citationSource.url === 'undefined';
}
function assertCitationSourceMedia(citationSource) {
 ...
 */
class ContentPartEventHelper extends ConversationEventHelperBase {
    constructor(message, contentPartId, 
    /**
    ...
    get startEvent() {
        ...
        return this.startEventMaybe; // timestamp is set in the constructor
    }
    /**
     ...
     * @throws Error if content part stream has already ended.
     */
    sendChunkWithCitationStart(chunk) {
        this.assertNotEnded();
     ...
     * @throws Error if content part stream has already ended.
     */
    sendChunkWithCitationEnd(chunk) {
        this.assertNotEnded();
     ...
     * @throws Error if content part stream has already ended.
     */
    sendContentPartEnd(endContentPart = {}) {
        this.assertNotEnded();
        this.setEnded();
        this.emit({ endContentPart });
        this.delete();
    }
    sendEndContentPart(endContentPart = {}) {
    ...
    onChunk(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._chunkHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onContentPartEnd(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._endHandlers.splice(index, 1);
        };
    }
    onEndContentPart(cb) {
    ...
    onCompleted(cb) {
        let data = '';
        const citationOffsets = new Map();
        const citations = new Array();
        const citationErrors = new Array();
        this.onChunk(chunk => {
        ...
        this.onContentPartEnd(endContentPart => {
            citationErrors.push(...Array.from(citationOffsets.keys())
...
class ContentPartEventHelperImpl extends ContentPartEventHelper {
    static *replay(contentPart) {
        yield {
            ...
            startContentPart: {
                ...
                timestamp: contentPart.createdTime ?? contentPart.createdAt,
     ...
     */
    dispatch(contentPartEvent) {
        if (contentPartEvent.contentPartId !== this.contentPartId)
            return;
        if (this._eventBuffer) {
    ...
    removeFromParent() {
        this.message.removeContentPart(this);
    }
    deleteChildren() {
    ...
    static *replayChunks(data, citations) {
        if (citations.length === 0) {
            ...
            citations.forEach((citation, index) => {
                if (index + 1 === citations.length)
                    return; // last one can't overlap
 ...
 */
class ToolCallEventHelper extends ConversationEventHelperBase {
    constructor(message, toolCallId, 
    /**
...
class ToolCallEventHelperImpl extends ToolCallEventHelper {
    static *replay(toolCall) {
        yield {
            toolCallId: toolCall.toolCallId,
            startToolCall: {
                toolName: toolCall.name,
                input: toolCall.input,
                timestamp: toolCall.createdTime ?? toolCall.createdAt
            }
        };
        if (toolCall.result) {
            yield {
     ...
     */
    dispatch(toolCallEvent) {
        if (toolCallEvent.toolCallId !== this.toolCallId)
            return;
        if (this._eventBuffer) {
    ...
    removeFromParent() {
        this.message.removeToolCall(this);
    }
    deleteChildren() {
 ...
 */
class MessageEventHelper extends ConversationEventHelperBase {
    constructor(exchange, messageId, 
    /**
    ...
    startEventMaybe) {
        ...
        this.startEventMaybe = startEventMaybe;
        this._contentPartMap = new Map();
        this._contentPartStartHandlers = new Array();
        this._endHandlers = new Array();
        this._toolCallStartHandlers = new Array();
    ...
    get startEvent() {
        ...
        return this.startEventMaybe; // timestamp is set by the constructor
    }
    /**
    ...
    onToolCallStart(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._toolCallStartHandlers.splice(index, 1);
        };
    }
    onToolCallCompleted(cb) {
    ...
    onInterruptStart(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._interruptStartHandlers.splice(index, 1);
        };
    }
    /**
     ...
     */
    sendInterrupt(interruptId, startInterrupt) {
        this.assertNotEnded();
        this.emit({
            interrupt: {
                interruptId,
     ...
     */
    sendInterruptEnd(interruptId, endInterrupt) {
        this.assertNotEnded();
        this.emit({
            interrupt: {
                interruptId,
...
class MessageEventHelperImpl extends MessageEventHelper {
    static *replay(message) {
        yield {
    ...
    dispatch(messageEvent) {
        if (messageEvent.messageId !== this.messageId)
            return;
        if (this._eventBuffer) {
        ...
        if (messageEvent.toolCall) {
            ...
            if (toolCallHelper)
                toolCallHelper.dispatch(messageEvent.toolCall);
        }
 ...
 */
class ExchangeEventHelper extends ConversationEventHelperBase {
    constructor(session, exchangeId, 
    /**
    ...
    startEventMaybe) {
        ...
        this._messageStartHandlers = new Array();
        this._endHandlers = new Array();
        this.addStartEventTimestamp(startEventMaybe);
    }
    /**
     ...
     */
    async sendMessageWithContentPart(options) {
        const { data, exchangeSequence, timestamp, role, mimeType, messageId } = options;
        await this.startMessage({ messageId, exchangeSequence, timestamp, role }, async (message) => await message.sendContentPart({ data, mimeType }));
    }
    /**
...
class ExchangeEventHelperImpl extends ExchangeEventHelper {
    static *replay(exchange) {
        yield {
            exchangeId: exchange.exchangeId,
            startExchange: {
                timestamp: exchange.createdTime ?? exchange.createdAt
            }
        };
    ...
    dispatch(exchangeEvent) {
        if (exchangeEvent.exchangeId !== this.exchangeId)
            return;
        if (this._eventBuffer) {
        ...
        if (exchangeEvent.message) {
            ...
            if (messageHelper)
                messageHelper.dispatch(exchangeEvent.message);
        }
    ...
    removeFromParent() {
        this.session.removeExchange(this);
    }
    deleteChildren() {
 ...
 */
class AsyncInputStreamEventHelper extends ConversationEventHelperBase {
     ...
     * @throws Error if input stream has already ended.
     */
    sendAsyncInputStreamEnd(endAsyncInputStream = {}) {
        this.assertNotEnded();
        this.setEnded();
     ...
     */
    sendEndAsyncInputStream(endAsyncInputStream = {}) {
...
class AsyncInputStreamEventHelperImpl extends AsyncInputStreamEventHelper {
    /**
     * Dispatches incoming stream events to registered handlers.
     */
    dispatch(streamEvent) {
        if (streamEvent.streamId !== this.streamId)
            return;
        if (this._eventBuffer) {
    ...
    removeFromParent() {
        this.session.removeInputStream(this);
    }
    deleteChildren() {
 ...
 */
class AsyncToolCallEventHelper extends ConversationEventHelperBase {
    constructor(session, toolCallId, 
    /**
     * ToolCallStartEvent used to initialize the ToolCallEventHelper. Will be undefined if some other sub-event was
     * received before the start event. See also `startEvent`.
     */
...
class AsyncToolCallEventHelperImpl extends AsyncToolCallEventHelper {
    /**
     * Dispatches incoming tool call events to registered handlers.
     */
    dispatch(toolCallEvent) {
    ...
    removeFromParent() {
        this.session.removeAsyncToolCall(this);
    }
    deleteChildren() {
 ...
 */
class SessionEventHelper extends ConversationEventHelperBase {
    constructor(manager, conversationId, 
    /**
     * SessionStartEvent used to initialize the SessionEventHelper. Will be undefined if some other sub-event was
     * received before the start event. See also `startEvent`.
     */
    startEventMaybe, echo = false) {
        super(manager);
        ...
        this._exchangeStartHandlers = new Array();
        this._inputStreamStartHandlers = new Array();
        this._asyncToolCallStartHandlers = new Array();
        this._asyncToolCallMap = new Map();
        this._labelUpdatedHandlers = new Array();
        this._sessionStartedHandlers = new Array();
        this._sessionEndingHandlers = new Array();
        this._sessionEndHandlers = new Array();
        this._emitBuffer = null;
        this._anyErrorStartHandlers = new Array();
        this._anyErrorEndHandlers = new Array();
    }
    /**
     ...
     */
    sendSessionStarted(sessionStarted = {}) {
        this.assertNotEnded();
    ...
    startExchange(argsOrCb, maybeCb) {
        this.assertNotEnded();
     ...
     */
    getAsyncInputStream(streamId) {
        return this._inputStreamMap.get(streamId);
    }
    startAsyncToolCall(args, cb) {
        this.assertNotEnded();
        const { toolCallId: providedId, properties, ...startToolCall } = args;
    ...
    onSessionStarted(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._sessionStartedHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onSessionEnding(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._sessionEndingHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onSessionEnd(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._sessionEndHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onExchangeStart(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._exchangeStartHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onLabelUpdated(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._labelUpdatedHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onAnyErrorStart(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._anyErrorStartHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onAnyErrorEnd(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._anyErrorEndHandlers.splice(index, 1);
        };
    }
    emitInternal(conversationEvent, suppressEcho = false) {
...
class SessionEventHelperImpl extends SessionEventHelper {
    /**
     * Dispatches incoming conversation events to registered handlers.
     */
    dispatch(conversationEvent) {
        if (conversationEvent.conversationId !== this.conversationId)
            return;
        if (this._eventBuffer) {
        ...
        if (conversationEvent.asyncInputStream) {
            ...
            if (streamHelper)
                streamHelper.dispatch(conversationEvent.asyncInputStream);
        }
        if (conversationEvent.asyncToolCall) {
            ...
            if (toolCallHelper)
                toolCallHelper.dispatch(conversationEvent.asyncToolCall);
        }
 ...
 */
class ConversationEventHelperManager {
    constructor(config) {
        this.config = config;
        ...
        // users of the SDK.
        this._sessionStartHandlers = new Array();
        this._sessionMap = new Map();
        this._anyEventHandlers = new Array();
        this._anyErrorStartHandlers = new Array();
        this._anyErrorEndHandlers = new Array();
        this._unhandledErrorStartHandlers = new Array();
        this._unhandledErrorEndHandlers = new Array();
    }
    ;
    makeId() {
    ...
    onAny(cb) {
        ...
        return () => {
            ...
            if (index !== -1)
                this._anyEventHandlers.splice(index, 1);
        };
    }
    /**
    ...
    onSessionStart(cb) {
        ...
        return () => {
            ...
            if (index >= 0)
                this._sessionStartHandlers.splice(index, 1);
        };
    }
    /**
     * @ignore
     */
    startSession(args, cb) {
     ...
     * @returns Cleanup function to remove the handler.
     */
    onUnhandledErrorEnd(cb) {
        this._unhandledErrorEndHandlers.push(cb);
        return () => {
            const index = this._unhandledErrorEndHandlers.indexOf(cb);
            if (index >= 0)
                this._unhandledErrorEndHandlers.splice(index, 1);
        };
    }
}
class ConversationEventHelperManagerImpl extends ConversationEventHelperManager {
    /**
     * Internal method.
     */
    dispatch(conversationEvent) {
     ...
     * Internal method.
     */
    dispatchUnhandledErrorEnd(args) {
 ...
 */
class ContentPartHelper {
    constructor(contentPart) {
 ...
 */
function transformExchanges(exchanges) {
 ...
 */
function transformExchange(exchange) {
    const transformed = transformData(exchange, ExchangeMap);
...
function transformMessage(message) {
    const transformed = transformData(message, MessageMap);
...
class ExchangeService extends BaseService {
     ...
     * ```
     */
    async getById(conversationId, exchangeId, options) {
        const params = {};
        if (options?.messageSort) {
            params.messageSort = options.messageSort;
        }
        const result = await this.get(EXCHANGE_ENDPOINTS.GET(conversationId, exchangeId), { params });
     ...
     * ```
     */
    async createFeedback(conversationId, exchangeId, options) {
        const response = await this.post(EXCHANGE_ENDPOINTS.CREATE_FEEDBACK(conversationId, exchangeId), options);
        return response.data;
    }
}
__decorate([
    track('ConversationalAgent.Exchanges.GetAll')
], ExchangeService.prototype, "getAll", null);
__decorate([
    track('ConversationalAgent.Exchanges.GetById')
], ExchangeService.prototype, "getById", null);
__decorate([
    track('ConversationalAgent.Exchanges.CreateFeedback')
], ExchangeService.prototype, "createFeedback", null);
 ...
 */
const LOG_LEVELS = [LogLevel.Debug, LogLevel.Info, LogLevel.Warn, LogLevel.Error];
/**
 ...
 * ```
 */
function parseWebSocketUrl(baseUrl, path) {
...
class BaseWebSocket {
     ...
     */
    constructor(config, executionContext, tokenManager, loggerPrefix = 'WebSocket') {
        ...
        this._connectionStatusHandlers = [];
...
/**
 * Conversational Agent Service Constants
 */
/**
 * WebSocket event names for conversational agent
 */
 ...
 */
const WEBSOCKET_LOGGER_PREFIX = 'ConversationalAgentSession';
...
class SessionManager {
    ...
    constructor(instance, options) {
        ...
        this._sessionSockets = new Map();
        /** Reverse mapping: Socket -> Set of conversation IDs using it */
        this._socketToConversations = new Map();
    ...
    _setupEventListeners() {
        this._session.addEventListeners({
            [WEBSOCKET_EVENTS.CONVERSATION_EVENT]: (data) => {
     ...
     */
    async _getSocket(conversationId) {
        ...
        if (!socket) {
            ...
            if (isNewSocket) {
                ...
                capturedSocket.on('disconnect', (reason) => {
     ...
     */
    _removeConversationFromSocket(conversationId, socket) {
     ...
     * @param conversationId - Conversation ID
     */
    _deprecateSocketForConversation(conversationId) {
        const socket = this._sessionSockets.get(conversationId);
        if (socket) {
...
class ConversationService extends BaseService {
     ...
     */
    async create(agentId, folderId, options) {
        ...
        const response = await this.post(CONVERSATION_ENDPOINTS.CREATE, apiPayload);
        const transformedData = transformData(response.data, ConversationMap);
     ...
     */
    async getById(id) {
        const response = await this.get(CONVERSATION_ENDPOINTS.GET(id));
        const transformedData = transformData(response.data, ConversationMap);
        return createConversationWithMethods(transformedData, this, this, this._exchangeService);
    }
    /**
    ...
    async updateById(id, options) {
        const response = await this.patch(CONVERSATION_ENDPOINTS.UPDATE(id), options);
        const transformedData = transformData(response.data, ConversationMap);
        return createConversationWithMethods(transformedData, this, this, this._exchangeService);
    }
    /**
     ...
     * ```
     */
    startSession(conversationId, options) {
        if (options?.logLevel) {
...
], ConversationService.prototype, "create", null);
__decorate([
    track('ConversationalAgent.Conversations.GetById')
], ConversationService.prototype, "getById", null);
__decorate([
    track('ConversationalAgent.Conversations.GetAll')
], ConversationService.prototype, "getAll", null);
__decorate([
    track('ConversationalAgent.Conversations.UpdateById')
], ConversationService.prototype, "updateById", null);
__decorate([
    track('ConversationalAgent.Conversations.DeleteById')
], ConversationService.prototype, "deleteById", null);
__decorate([
...
class MessageService extends BaseService {
     ...
     * ```
     */
    async getById(conversationId, exchangeId, messageId) {
        const result = await this.get(MESSAGE_ENDPOINTS.GET(conversationId, exchangeId, messageId));
     ...
     * ```
     */
    async getContentPartById(conversationId, exchangeId, messageId, contentPartId) {
        const result = await this.get(MESSAGE_ENDPOINTS.GET_CONTENT_PART(conversationId, exchangeId, messageId, contentPartId));
        return new ContentPartHelper(result.data);
    }
}
__decorate([
    track('ConversationalAgent.Messages.GetById')
], MessageService.prototype, "getById", null);
__decorate([
 ...
 */
class ConversationalAgentService extends BaseService {
    /**
    ...
    async getAll(folderId) {
        const response = await this.get(AGENT_ENDPOINTS.LIST, {
            params: folderId !== undefined ? { folderId } : undefined,
        });
        return response.data.map((agent) => createAgentWithMethods(transformData(agent, AgentMap), this.conversations));
    }
    /**
     ...
     * ```
     */
    async getById(id, folderId) {
        const response = await this.get(AGENT_ENDPOINTS.GET(folderId, id));
        return createAgentWithMethods(transformData(response.data, AgentMap), this.conversations);
    }
    /**
    ...
    async getFeatureFlags() {
        const response = await this.get(FEATURE_ENDPOINTS.FEATURE_FLAGS);
        return response.data;
    }
}
__decorate([
    track('ConversationalAgent.GetAll')
], ConversationalAgentService.prototype, "getAll", null);
__decorate([
